...
const MyOrdersInvoice = () => {
    return (
        <GridLayout className="mt-12 border border-[#D7DADE] py-6 px-3 gap-10">
            ...
            <InvoiceDetailItem title="Shipping" dateCaption="Date Shipped" date="03/03/2022">
            ...
            <InvoiceDetailItem title="Order Details" dateCaption="Date Ordered" date="27/02/2022">
                <TableContainer className='desktop_only' >
                    <Table sx={{ minWidth: 650 }}  >
                        <TableHead >
                            <TableRow >
                                <TableCell align="left" className='font-inter !font-bold text-base'>Ordered</TableCell>
                                <TableCell align="left" className='font-inter !font-bold text-base'>Item Number</TableCell>
                                <TableCell align="left" className='font-inter !font-bold text-base'>Description</TableCell>
                                <TableCell align="left" className='font-inter !font-bold text-base'>Unit Price</TableCell>
            ...
            <InvoiceDetailItem title="Payment" dateCaption="Due Date" date="03/03/2022">
...
const AccountMyOrdersInvoice = () => {
    return (
        <AccountLayout  page="Invoice"> <MyOrdersInvoice /></AccountLayout>
    )
}
