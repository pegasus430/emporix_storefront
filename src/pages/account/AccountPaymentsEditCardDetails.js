      ...
      <GridLayout className="mt-12 justify-center gap-12">
            <GridLayout className="md:w-[65%] w-full gap-2 m-auto">
                ...
                <div className="lg:flex grid gap-2">
                    <TextInput label="Expiry Date" className="lg:w-1/3 w-full" placeholder="placeholder" value=""/>
                    <TextInput label="Security Code" className="lg:w-1/3 w-full"  placeholder="placeholder" value=""/>
                </div>
            </GridLayout>
...
const AccountPaymentsEditCardDetails = () => {
    return <AccountLayout  page="Edit Card Details"> <PaymentsEditCardDetails /></AccountLayout>;
};
