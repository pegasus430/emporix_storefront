...
import './account.css'
const PayItem = ({title, itemKey, className, children}) => {
...
const Payments = () => {
  ...
  return (
    <GridLayout className="mt-20 gap-20">
      <GridLayout className="gap-6 p-2 md:w-1/2 w-full m-auto">
        <PayItem  title="Pay by Credit Card" itemKey="credit_card">
