        ...
        >
          <div className="content">
                <div className='flex justify-between text-black'>
                    ...
                    <input className='w-[45%] border border-[#D7DADE] h-8' type="text" placeholder='To' />
                </div>
                <div>
...
const MobileFilterPanel= (props) => {
    ...
    return (
            <div className='md:hidden min-w-[375px] text-black absolute top-0 left-0 w-full  h-screen bg-white px-6 py-12  text-center font-medium overflow-y-auto z-50' >
